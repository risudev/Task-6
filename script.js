...
const movie1 = new Movie("Leo", "lalit Kumar", "PG13");
const movie2 = new Movie("Vikram", "kamal production", "*****");
...
var person1 = new Person("Riswan", "N", "11-07-2001", "Ranipet");
var person2 = new Person("Mohammed", "Sufiyan", "x-x-xxxx", "Gudiyatham");
var person3 = new Person("Hasim", "Babu", "x-x-xxxx", "Ranipet");
var person4 = new Person("mohammed", "Fayaz", "x-x-xxxx", "Vellore");
var person5 = new Person("Tauffiq", "Idly", "x-x-xxxx", "Vellore");
var person6 = new Person("mohammed", "Furkhan", "x-x-xxxx", "Vaniyambadi");
